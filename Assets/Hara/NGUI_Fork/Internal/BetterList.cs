...
public class BetterList<T>
{
	...
	public void Sort (System.Comparision<T> comparer) { mList.Sort(comparer); }
	...
	//{
	//    public System.Comparision<T> func;
	...
	//public void Sort (System.Comparision<T> comparer)
	//{
	//    if (size > 0)
	//    {
	//        mComp.func = comparer;
	...
	/// <summary>
	/// Comparision function should return -1 if left is less than right, 1 if left is greater than right, and 0 if they match.
	/// </summary>
